async function main() {
  ...
  const MyToken = await hre.ethers.getContractFactory("CrimeanNFT");
  ...
  await nft.safeMint(await signer0.getAddress(), "ipfs://QmTfYdAmK5eBcjCWqLBaoTHGERFEbsAXkPSiKPDhKxPnig");
